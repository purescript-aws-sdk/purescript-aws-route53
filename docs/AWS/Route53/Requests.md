...
``` purescript
createQueryLoggingConfig :: forall eff. Service -> CreateQueryLoggingConfigRequest -> Aff (exception :: EXCEPTION | eff) CreateQueryLoggingConfigResponse
```
